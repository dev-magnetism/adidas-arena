<template>
  <div class="app-accessibilite-numerique grid-inner">
    <AtomsCTABack @click.native="onBack()"> Retour </AtomsCTABack>

    <div class="app-accessibilite-numerique__inner">
      <TH2 class="app-accessibilite-numerique__title">{{
        content.data.title
      }}</TH2>
