  ...
  <div class="app-arena-plan">
    <div class="app-arena-plan__inner grid-inner">
      ...
      <div class="app-arena-plan__visual">
        ...
        <AtomsTitleTag
          ref="mainPlace"
          class="app-arena-plan__visual__main-place"
          bg="blue-adidas"
          color="white"
        ...
        <AtomsTitleTag
          ref="secondPlace"
          class="app-arena-plan__visual__second-place"
          bg="blue-adidas"
          color="white"
          >{{ contents.basilique }}</AtomsTitleTag
        >
        <SvgPlan ref="svg" class="app-arena-plan__svg" />
        <SvgPlanMobile ref="svgMobile" class="app-arena-plan__svg-mobile" />
        <div ref="circle" class="app-arena-plan__visual__circle-01" />
        <div
          ref="littleArrow2"
          class="app-arena-plan__visual__little-arrow-2"
        />
        <div
          ref="littleArrow3"
          class="app-arena-plan__visual__little-arrow-3"
        />
        <div
          ref="littleArrow1"
          class="app-arena-plan__visual__little-arrow-1"
        />
...
.app-arena-plan {
  ...
  &__visual {
    ...
    &::after {
      content: '';
      background: url('/imgs/arena/plan-bg.webp');
      position: absolute;
      top: 0;
      left: 0;
      width: 100%;
