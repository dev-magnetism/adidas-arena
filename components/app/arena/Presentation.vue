<template>
  <div class="app-arena-presentation grid-inner">
    <div class="app-arena-presentation__row-framed-content">
      <ERichText ref="title" tag="h1" :content="contents.title" />
      <ERichText ref="paragraph" :content="contents.subtitle" />
    </div>

    <div ref="visualFramed" class="app-arena-presentation__row-framed-visual">
      <EKinesis :speed="5">
    ...
    <div
      ref="visualBigger"
      class="app-arena-presentation__row-second-visual-principal"
    >
      <EKinesis :speed="5">
    ...
    <EParallax
      ...
      :speed="0.6"
      class="app-arena-presentation__row-second-visual-transparent"
    >
      <EKinesis :speed="10">
        <nuxt-picture
    ...
    <div class="app-arena-presentation__row-second-content">
