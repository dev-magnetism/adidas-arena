<template>
  <div class="app-be-part-of-partenaire-partenaires grid">
    <div class="app-be-part-of-partenaire-partenaires__content">
      <ERichText
        :split="true"
        :scrub="false"
        :overflow="true"
      ...
      />
      <TP2
        class="app-be-part-of-partenaire-partenaires__principal-paragraph partners-apparition"
        weight="bold"
      >
        {{ contents.subtitle }}
      </TP2>
      <TP2
        weight="medium"
        class="app-be-part-of-partenaire-partenaires__secondary-paragraph partners-apparition"
      >
        {{ contents.paragraph }}
      </TP2>
