<template>
  <div class="app-business-experience grid-inner" :class="{novideo: !videoFrame}">
    <div
      v-if="imageFrame || imageWithoutFrame || videoFrame"
      class="app-business-experience__left"
    >
      <EParallax
        v-if="imageFrame"
        ref="withFrame"
        class="app-business-experience__visual-with-frame"
        :speed="0.85"
      >
        <EKinesis :speed="6">
      ...
      <EParallax
        ...
        ref="withoutFrame"
        class="app-business-experience__visual-without-frame"
        :speed="0.95"
      >
        <EKinesis :speed="7">
			<nuxt-img
      ...
      <EParallax
        ...
        class="app-business-experience__video"
        :speed="1"
      >
        <EKinesis :speed="5">
          <div
            ...
            class="app-business-experience__video__overlay"
    ...
    <div class="app-business-experience__right">
...
.app-business-experience {
  ...
  &__video.app-parallax {
    ...
    .app-business-experience__video__overlay {
      position: absolute;
      top: 0;
      left: 0;
      width: 100%;
